 ...
 * The secondary and tertiary palettes are split from the source color by 150 degrees in each direction.
 *
...
export class SchemeSplit extends DynamicScheme {
  constructor(sourceColorHct, isDark, contrastLevel) {
    super({
      ...
      secondaryPalette: TonalPalette.fromHueAndChroma(math.sanitizeDegreesDouble(sourceColorHct.hue + 150.0), sourceColorHct.chroma),
      tertiaryPalette: TonalPalette.fromHueAndChroma(math.sanitizeDegreesDouble(sourceColorHct.hue - 150.0), sourceColorHct.chroma),
