    ...
    <v-row class="flex-1-1-100">
      ...
      <v-col cols="12" sm="6" md="6" lg="4" xl="3" mobile-break-point="760">
        ...
        <v-row class="flex-grow-0">
          <v-col>
            <!-- [*] SOURCE COLOR CARD -->
            <v-card class="d-flex flex-column" :color="sourceColor" density="compact">
              <v-card-item>
              ...
              <v-expand-transition>
                <v-row v-if="showVariantInfo" no-gutters>
                  <v-col>
                    <v-card-text class="py-2 overflow-y-auto" style="height: 108px; line-height: 1.25rem">
